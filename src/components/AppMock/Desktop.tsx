    ...
    <>
      <div className="yr-main-content">
        <section className="yr-model">
          <picture className="yr-model__placeholder yr-image yr-model__hidden">
            <img alt="Model" height="550" width="1100" src="https://cdn-prod.fluidconfigure.com/static/fluid-implementation-lux.s3.amazonaws.com/lux-ocp/rbn/assets/img/sk.webp" />
          </picture>
        </section>
        <div className="yr-menu">
          <header className="yr-custom-header">
            <div className="yr-header-title yr-skeleton">
              <span>TEST NAME</span>
            </div>
          </header>
          <div className="yr-customizer">
            <details className="yr-accordion">
              <summary className="yr-accordion-summary">
                <div className="yr-skeleton yr-image yr-accordion-summary-image">
                </div><div className="yr-accordion-header">
                  <h3 className="yr-skeleton yr-accordion-header-title">Front</h3>
                  <p className="yr-skeleton yr-accordion-header-selected">Black</p>
                </div>
                <button className="yr-button yr-button-rounded yr-skeleton" tabIndex={-1}>
                </button>
              </summary>
            </details>
            <details className="yr-accordion">
      ...
      <div className="yr-footer">
        <div className="yr-buttons-section">
          <button className="yr-button yr-button-rounded yr-skeleton">
            <span className="yr-button-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" className="yr-icon-try-on">
